...
class PlayState extends MusicBeatState
{
	...
	override function stepHit()
	{
		...
		if (curSong == 'Tutorial-Remix') 
		{
			switch (curStep)
			{
				...
				case 192:
				iconP2.animation.play('gf2-1');
				
				case 202:
				iconP2.animation.play('gf2-2');
				...
				case 224:
				iconP1.animation.play('bf2-2');
				
				case 234:
				iconP1.animation.play('bf2-1');
				...
				case 256:
				iconP2.animation.play('gf3-1');
				
				case 258:
				iconP2.animation.play('gf3-3');
				
				case 260:
				iconP2.animation.play('gf3-2');
				...
				case 288:
				iconP1.animation.play('bf3-3');
				
				case 290:
				iconP1.animation.play('bf3-1');
				
				case 292:
				iconP1.animation.play('bf3-2');
				...
				case 320:
				iconP2.animation.play('gf4-1');
				
				case 322:
				iconP2.animation.play('gf4-2');
				
				case 324:
				iconP2.animation.play('gf4-3');
				...
				case 352:
				iconP1.animation.play('bf4-1');
				
				case 354:
				iconP1.animation.play('bf4-2');
				
				case 356:
				iconP1.animation.play('bf4-3');
			...
			{
				if(boyfriend.animation.curAnim.name == 'singLEFTmiss')
				{
					iconP1.animation.play('bf1-1');
				}
				
				if(boyfriend.animation.curAnim.name == 'singRIGHTmiss')
				{
					iconP1.animation.play('bf1');
				}
				
				if(boyfriend.animation.curAnim.name == 'singUPmiss')
				{
					iconP1.animation.play('bf1-2');
				}

				if(boyfriend.animation.curAnim.name == 'singDOWNmiss')
				{
					iconP1.animation.play('bf');
				}
			}
	...
	override function beatHit()
	{
		...
		if (curBeat == 46 && curSong == 'Tutorial-Remix')
		{
			dad.playAnim('cheer', true);
		}
		
		if (curBeat == 62 && curSong == 'Tutorial-Remix')
		{
			dad.playAnim('cheer', true);
		}
		
		if (curBeat == 78 && curSong == 'Tutorial-Remix')
		{
			dad.playAnim('cheer', true);
		}
